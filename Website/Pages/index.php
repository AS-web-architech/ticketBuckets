...
<body>
    <div class="section full-height over-hide z-bigger mt-5">
        <div class="hero-center-section" style="height:92vh ;background-image:linear-gradient(rgba(0,0,0,0.9),rgba(0,0,0,0.6)), url(../Assets/images/MovieBg/11.jpg);background-repeat: no-repeat;background-position: center;background-size:cover;">
          <div class="container cente">
            <div class="row justify-content-center" >
              ...
              <div class="col-12 col-sm-7 col-md-7 col-lg-5 col-xl-4 pl-4 align-self-center pt-5 mt-4 mt-sm-0 text-center text-sm-left">
                <h3 class="mb-1 text-white"><b>Supernatural</b> </h3>
        ...
        <div class="hero-center-section" style="height:92vh ;background-image:linear-gradient(rgba(0,0,0,0.9),rgba(0,0,0,0.6)), url(../Assets/images/MovieBg/web.ae_.beautyanbg.jpg);background-repeat: no-repeat;background-position: center;background-size:cover;">
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-12 col-sm-5 col-md-5 col-xl-4 mt-4 align-self-center">
                <div class="img-wrap">
                  <img src="../Assets/images/moviecard/beauty_and_the_beastcard.webp" alt="">
                </div>
              </div>
              <div class="col-12 col-sm-7 col-md-7 col-lg-5 col-xl-4 pl-4 align-self-center mt-4 mt-sm-0 text-center text-sm-left">
                <h3 class="mb-1 text-white"><b>Arrow</b> </h3>

...
<head>
    ...
    <link rel="stylesheet" href="../Assets/css/crasoule.css">
    <link
    ...
    <div class="container-fluid" style="border: 2px solid red;">
        <div class="container content-container">
            <div class="featured-content"
                style="background: linear-gradient(to bottom, rgba(0,0,0,0), #151515), url('../Assets/images/MovieBg/f-1.jpg');">
                <img class="featured-title" src="../Assets/images/MovieBg/f-1.png" alt="">
